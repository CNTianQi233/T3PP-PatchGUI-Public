        ...
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            DispatcherUnhandledException += (_, args) =>
            {
                try
                {
                    ...
                    CrashReportWriter.TryCaptureForUnhandledException("DispatcherUnhandledException", args.Exception);
                }
                catch { }
            };
            ...
            AppDomain.CurrentDomain.UnhandledException += (_, args) =>
            {
                try
                {
                    ...
                    if (args.ExceptionObject is Exception ex)
                    {
                        ...
                        CrashReportWriter.TryCaptureForUnhandledException("AppDomain.UnhandledException", ex);
                    }
                    else
                    {
                        SessionLog.Write("EX", $"ExceptionObject={args.ExceptionObject}");
                        CrashReportWriter.TryCaptureForUnhandledException("AppDomain.UnhandledException", null);
                    }
                }
                catch { }
            };
